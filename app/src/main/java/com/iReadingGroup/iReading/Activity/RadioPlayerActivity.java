...
import com.iReadingGroup.iReading.Adapter.StationListAdapter;
import com.iReadingGroup.iReading.R;
import com.iReadingGroup.iReading.Station;
...
public class RadioPlayerActivity extends AppCompatActivity implements Player.EventListener {
    ...
    public static class MsgHandler extends Handler {
        WeakReference<RadioPlayerActivity> mRadioPlayerActivityWeakReference;

        MsgHandler(RadioPlayerActivity radioPlayerActivity) {
            mRadioPlayerActivityWeakReference = new WeakReference<>(radioPlayerActivity);
        }
        ...
        public void handleMessage(@NotNull Message msg) {
            ...
            RadioPlayerActivity radioPlayerActivity = mRadioPlayerActivityWeakReference.get();

            if (msg.what == MSG_LOAD_LIST) {
                radioPlayerActivity.initStationListView();
            }
            else if (msg.what == MSG_PLAY) {
                int selectedPosition = (int) msg.obj;
                radioPlayerActivity.mCurrentStation = radioPlayerActivity.mStationList.get(selectedPosition);
                radioPlayerActivity.setCurrentPlayInfo(radioPlayerActivity.mCurrentStation);
                radioPlayerActivity.play(radioPlayerActivity.mCurrentStation.url);
            }
        }
    }
    ...
    protected void initializePlayer (){
        ...
        dataSourceFactory = new DefaultDataSourceFactory(this, Util.getUserAgent(this, "iReading"));
