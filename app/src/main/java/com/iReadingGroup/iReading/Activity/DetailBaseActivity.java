 ...
 *
 * 在此类中封装了一些单词详情页和文章详情页的功用的方法，例如单词弹窗，点击单词发声，获取单词释义等
 */
public abstract class DetailBaseActivity extends AppCompatActivity {
     ...
     */
    protected ToggledImageView ppwCollectionImageView;//用来切换图标
    ...
    protected void FetchBriefMeaning() {//修改查词策略（获取单词的简要释义）
