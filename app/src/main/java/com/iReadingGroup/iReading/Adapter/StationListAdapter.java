...
public class StationListAdapter extends RecyclerView.Adapter<StationListAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        Glide.with(mContext)
                .asBitmap()
                .load(RadioPlayerActivity.ServerPrefix + "logo/" + mStationList.get(position).logo)
                .into(holder.stationLogo);

        String flagResource = ((RadioPlayerActivity)mContext).getFlagResourceByCountry(mStationList.get(position).country);
        ...
        holder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                msg.obj = position;
                msg.what = RadioPlayerActivity.MSG_PLAY;
                ((RadioPlayerActivity)mContext).mHandler.sendMessage(msg);
            }
        });
